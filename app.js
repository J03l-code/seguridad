  ...
  try {
    ...
    window.changeTaskStatus = async function (id, status) {
      try {
        ...
        if (t && status === 'review') {
            const spLink = prompt("Ingrese el enlace de SharePoint del entregable a revisar (Asegúrese de incluir https:// al inicio):");
        ...
        allDeptIds.forEach(deptId => {
            ...
            <div class="act-dept-card" data-dept="${deptId}" style="border-top:4px solid ${color};background:var(--gray-50);border-radius:12px;padding:16px;box-shadow:var(--shadow-md);min-width:320px;max-width:320px;flex:0 0 auto;display:flex;flex-direction:column;gap:0;">
                ...
                <div style="border-top:2px dashed ${color}33;padding-top:14px;">
                    <div id="act-section-label-${deptId}" contenteditable="true" spellcheck="false" title="Haz clic para editar" style="font-size:11px;font-weight:800;text-transform:uppercase;color:${color};letter-spacing:0.7px;margin-bottom:10px;text-align:center;outline:none;border-radius:4px;padding:2px 6px;cursor:text;transition:background 0.2s;" onmouseover="this.style.background='${color}18'" onmouseout="if(document.activeElement!==this)this.style.background='transparent'" onfocus="this.style.background='${color}22';this.style.outline='1px solid ${color}55'" onblur="this.style.background='transparent';this.style.outline='none'">&#128203; Actividades del Departamento</div>
